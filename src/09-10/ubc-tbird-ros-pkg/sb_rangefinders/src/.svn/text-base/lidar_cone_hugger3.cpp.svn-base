 ...
 * Summer 2010
 * /opt/ros/boxturtle/stacks/laser_drivers/hokuyo_node/cfg$ 
 **/
...
// std::cout << "# rays: " << (angle_max-angle_min)/(angle_increment) << std::endl;
   ...
   for (int i=ANGLE_MIN; i < NUM_RAYS+ANGLE_MIN; i++)
   {
...
*/
   ...
   if(myRanges[NUM_RAYS/2] < 1.0)
     sharpness = 3;
   else if(myRanges[NUM_RAYS/2] < 2.0)
     sharpness = 2;
   else
     sharpness = 1;
